...
ShaderComponentOutline::ShaderComponentOutline(ComponentShaderBase * _shader, float _alphaDiscardThreshold) :
...
ShaderComponentOutline::~ShaderComponentOutline(){
}

std::string ShaderComponentOutline::getVertexVariablesString(){
...
std::string ShaderComponentOutline::getVertexBodyString(){
	return "";
}
...
void ShaderComponentOutline::clean(sweet::MatrixStack* _matrixStack, RenderOptions* _renderOption, NodeRenderable* _nodeRenderable){
	makeDirty();
...
void ShaderComponentOutline::load(){
	if(!loaded){
...
void ShaderComponentOutline::unload(){
	if(loaded){
		texNumLoc = -1;
		texSamLoc = -1;
		numTextures = 0;
...
void ShaderComponentOutline::configureUniforms(sweet::MatrixStack* _matrixStack, RenderOptions* _renderOption, NodeRenderable* _nodeRenderable){
