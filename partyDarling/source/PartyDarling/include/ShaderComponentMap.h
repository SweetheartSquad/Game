...
*
******************************************************************************/
class ShaderComponentMap : public ShaderComponent{
private:
...
public:
	...
	ShaderComponentMap(ComponentShaderBase * _shader, float _alphaDiscardThreshold = -1);
	~ShaderComponentMap() override;
